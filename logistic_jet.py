...
model = LogisticRegression(solver='lbfgs', max_iter=1000, multi_class='multinomial', random_state=0)
...
with open('./model_logistic.p', 'wb') as f:
    pickle.dump((model, label_encoder, pca), f)

print("Model saved as 'model_logistic.p'")
